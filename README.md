# PayeTonKawa - Service Commandes 

Service de gestion des commandes pour l'application PayeTonKawa.
...
La documentation Swagger est disponible à l'adresse : `http://localhost:3002/api-docs`
